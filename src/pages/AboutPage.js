...
import {logoInstagram, logoFacebook, mailOutline} from 'ionicons/icons';
...
const AboutPage = () => {
  return (
    ...
    <IonContent fullscreen style={{paddingLeft: '10px', paddingRight: '10px'}}>
      ...
      <h1 style={{textAlign: "center", fontFamily: "Impact", fontSize: "30px", fontWeight: "600"}}> Our Vision</h1>
      <p style={{textAlign: "center", marginLeft: "20px", fontSize: "20px", marginRight: "20px", marginTop: "-7px"}}>Strive Now's Vision is to empower you to fulfill your potential for today and
        prepare you to do it again tomorrow.</p>

      <center><img src={groupImg} style = {{width: "75%", height: "auto"}}></img></center>
      <h1 style={{textAlign: "center", fontFamily: "Impact", fontSize: "30px", fontWeight: "600"}}> Our Goal</h1>
      <p style={{textAlign: "center", marginLeft: "20px", fontSize: "20px", marginRight: "20px", marginTop: "-7px"}}>Strive Now is about teaching young adults and teens where they are at, like looking at a mountain. You 
        wouldn't point someone to the peak and expect them to know how to get up there.</p>
      <h1 style={{textAlign: "center", fontFamily: "Impact", fontSize: "30px", fontWeight: "600"}}> We Will...</h1>
      ...
      <h1 style={{textAlign: "center", fontFamily: "Impact", fontSize: "30px", fontWeight: "600"}}> How?</h1>
      <ul>
      ...
      <h1 style={{textAlign: "center", fontFamily: "Impact", fontSize: "30px", fontWeight: "600", marginBottom: "20px"}}>Connect with Strive!</h1>
